    ...
    <div class="card mt-2">
        <div class="card-header d-flex justify-content-between">
            <div class="header-title">
                <h4 class="card-title">Lihat Data Preorder</h4>
            </div>
                        ...
                        <table class="w-full table-fixed text-sm border border-gray-300">
                            <thead class="bg-gray-100 text-gray-700">
                                <tr>
                                    ...
                                    <th class="px-4 py-2 border border-gray-300 w-1/6">Harga</th>
                                    <th class="px-4 py-2 border border-gray-300 w-1/6">Total</th>
                                    <th class="px-4 py-2 border border-gray-300 w-1/6">Type</th>
                                </tr>
                            </thead>
                            <tbody>
