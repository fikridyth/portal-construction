<div class="flex align-items-center list-preorder-action">
    {{-- <a class="btn btn-sm btn-icon btn-primary" data-bs-toggle="tooltip" title="Lihat Data Dokumentasi Mingguan" href="{{ route('preorder.show',$id) }}">
        <span class="btn-inner">
            <i class="fas fa-eye mt-1"></i>
        </span>
    </a> --}}
    {{-- <a class="btn btn-sm btn-icon btn-warning" data-bs-toggle="tooltip" title="Ubah Data dokumentasi Mingguan" href="{{ route('preorder.edit',$id) }}">
        <span class="btn-inner">
    ...
    <?php 
    $message = __('global-message.delete_alert', ['form' => __('preorder.title')])
    ?>
