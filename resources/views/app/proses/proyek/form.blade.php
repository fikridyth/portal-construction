                ...
                <div class="card-body">
                    <div class="new-user-info">
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                <label class="form-label" for="kontrak">Kontrak: <span
                                        class="text-danger">*</span></label>
                            ...
                            <div class="form-group col-md-6">
                                <label class="form-label" for="pelaksana">Pelaksana: <span
                                        class="text-danger">*</span></label>
                            ...
                            <div class="form-group col-md-6">
                                <label class="form-label" for="direktur">Direktur: <span
                                        class="text-danger">*</span></label>
                            ...
                            <div class="form-group col-md-6">
                                <label class="form-label" for="dari">Tanggal Mulai: <span
                                        class="text-danger">*</span></label>
                            ...
                            <div class="form-group col-md-6">
                                <label class="form-label" for="sampai">Tanggal Selesai: <span
                                        class="text-danger">*</span></label>
                            ...
                            <div class="form-group col-md-6">
                                <label class="form-label" for="total_meter">Luas Bangunan: <span
                                        class="text-danger">*</span></label>
                                {{ Form::text('total_meter', $data->total_meter ?? old('total_meter'), ['class' => 'form-control placeholder-grey', 'id' => 'total_meter', 'placeholder' => 'Isi Data Luas Bangunan', 'required']) }}
                            </div>
                            <div class="form-group col-md-6">
                            ...
                            <div class="form-group col-md-4">
                                <label class="form-label" for="nama">User Project Manager: <span class="text-danger">*</span></label>
                                {{ Form::select(
                                    'user_pm',
                                    $userManager->mapWithKeys(function ($item) {
                                        return [$item->id => $item->first_name . ' ' . $item->last_name];
                                    }),
                                    old('user_pm', $data->user_pm ?? null), [
                                    'class' => 'form-control placeholder-grey',
                                    'placeholder' => 'Pilih User Project Manager',
                                    'required',
                                    'id' => 'user_pm'
                                ]) }}
                            </div>
                            <div class="form-group col-md-4">
                                <label class="form-label" for="nama">User Supervisor: <span class="text-danger">*</span></label>
                                {{ Form::select(
                                    'user_spv',
                                    $userSupervisor->mapWithKeys(function ($item) {
                                        return [$item->id => $item->first_name . ' ' . $item->last_name];
                                    }),
                                    old('user_spv', $data->user_spv ?? null), [
                                    'class' => 'form-control placeholder-grey',
                                    'placeholder' => 'Pilih User Supervisor',
                                    'required',
                                    'id' => 'user_spv'
                                ]) }}
                            </div>
                            <div class="form-group col-md-4">
                                <label class="form-label" for="nama">User Finance: <span class="text-danger">*</span></label>
                                {{ Form::select(
                                    'user_purchasing',
                                    $userFinance->mapWithKeys(function ($item) {
                                        return [$item->id => $item->first_name . ' ' . $item->last_name];
                                    }),
                                    old('user_purchasing', $data->user_purchasing ?? null), [
                                    'class' => 'form-control placeholder-grey',
                                    'placeholder' => 'Pilih User Finance',
                                    'required',
                                    'id' => 'user_purchasing'
                                ]) }}
                            </div>
                        ...
                        <button type="submit" id="submitButton" class="btn btn-primary"
                            disabled>{{ $id !== null ? 'Ubah' : 'Tambah' }} Data Proyek</button>
                    </div>
                </div>
            </div>
        </div>
