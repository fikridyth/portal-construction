<div class="flex align-items-center list-laporan-kegiatan-action">
    {{-- <a class="btn btn-sm btn-icon btn-primary" data-bs-toggle="tooltip" title="Lihat Data Laporan Kegiatan" href="{{ route('laporan-kegiatan.show',$id) }}">
        <span class="btn-inner">
            <i class="fas fa-eye mt-1"></i>
        </span>
    </a> --}}
    {{-- <a class="btn btn-sm btn-icon btn-warning" data-bs-toggle="tooltip" title="Ubah Data Laporan Kegiatan" href="{{ route('laporan-kegiatan.edit',$id) }}">
        <span class="btn-inner">
    ...
    <?php 
    $message = __('global-message.delete_alert', ['form' => __('laporan-kegiatan.title')])
    ?>
