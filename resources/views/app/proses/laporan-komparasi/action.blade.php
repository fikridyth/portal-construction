<div class="flex align-items-center list-laporan-komparasi-action">
    ...
    {{-- <a class="btn btn-sm btn-icon btn-warning" data-bs-toggle="tooltip" title="Ubah Data Laporan Komparasi" href="{{ route('laporan-komparasi.edit',$id) }}">
        <span class="btn-inner">
    ...
    <?php 
    $message = __('global-message.delete_alert', ['form' => __('laporan-komparasi.title')])
    ?>
