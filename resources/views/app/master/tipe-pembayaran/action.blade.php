<div class="flex align-items-center list-tipe-pembayaran-action">
    <a class="btn btn-sm btn-icon btn-warning" data-bs-toggle="tooltip" title="Ubah Data Tipe Pembayaran" href="{{ route('tipe-pembayaran.edit',enkrip($id)) }}">
    ...
    <?php 
    $message = __('global-message.delete_alert', ['form' => __('tipe-pembayaran.title')])
    ?>
