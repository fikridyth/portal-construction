<div class="flex align-items-center list-supplier-action">
    <a class="btn btn-sm btn-icon btn-warning" data-bs-toggle="tooltip" title="Ubah Data Supplier" href="{{ route('supplier.edit',enkrip($id)) }}">
    ...
    <?php
    $message = __('global-message.delete_alert', ['form' => __('supplier.title')])
    ?>
