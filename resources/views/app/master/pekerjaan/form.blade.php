       ...
       <div>
            <div class="card mt-2">
                ...
                <div class="card-action">
                        <a href="{{route('pekerjaan.index')}}" class="btn btn-sm btn-warning" role="button">Kembali</a>
                </div>
                </div>
                <div class="card-body">
                    <div class="new-user-info">
                        ...
                        <button type="submit" id="submitButton" class="btn btn-primary" disabled>{{$id !== null ? 'Ubah' : 'Tambah' }} Data Pekerjaan</button>
                    </div>
                </div>
            </div>
        </div>
